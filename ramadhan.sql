...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2022 at 03:12 AM
...
--
-- Table structure for table `menu_berbuka`
--
...
--
-- Dumping data for table `menu_berbuka`
--
...
--
-- Table structure for table `sholat_terawih`
--
...
--
-- Dumping data for table `sholat_terawih`
--

INSERT INTO `sholat_terawih` (`tanngal`, `imam`, `masjid`) VALUES
...
--
-- Indexes for table `menu_berbuka`
--
ALTER TABLE `menu_berbuka`
  ADD PRIMARY KEY (`tanggal`);

--
-- Indexes for table `sholat_terawih`
--
ALTER TABLE `sholat_terawih`
  ADD PRIMARY KEY (`tanngal`);
COMMIT;
